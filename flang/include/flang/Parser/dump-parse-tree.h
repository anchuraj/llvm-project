...
#include "llvm/Frontend/OpenMP/OMP.inc"
  ...
  NODE(parser, OmpScanDirective)
  NODE(parser, OmpScanDirectiveWithClauses)
  NODE(parser, OpenMPScanPreBlock)
  NODE(parser, OpenMPScanPostBlock)
  ...
  NODE(parser, OpenMPScanConstruct)
